...
def test_jcsigmoid():
    ...
    func2=functions.Reshape(input_shape, itype=itype, output_shape=input_shape)
    func3=Linear(input_shape, itype=itype, weight=typed_randn(itype, (nfo,nfi)),bias=typed_randn(itype,(nfo,)))
    func3_=Linear(input_shape, itype=itype, weight=typed_randn(itype, (nfo,nfi)),bias=typed_randn(itype,(nfo,)))
...
def test_keepsign():
    ...
    func2=Linear(input_shape, itype=itype, weight=typed_randn(itype, (nfo,nfi)),bias=typed_randn(itype,(nfo,)))
    func3=ANN(layers=[functions.Abs(input_shape=input_shape,itype='complex128')])
...
def test_derivatives():
    funcs = ['KS_Tanh', 'KS_Georgiou1992', 'JC_Tanh', 'JC_Sigmoid', 'JC_Georgiou1992']
    input_shape = (8,8)
    itype = 'complex128'
    for func_i in funcs:
        kwargs = {}
